...
| `03-001-favorites` | READY | Favorite concerts: SQLite-backed LibraryRepository, heart toggle on concert detail, Library tab shows favorites | summary: `workflow/packets/03-001-favorites.summary.md` | — |
